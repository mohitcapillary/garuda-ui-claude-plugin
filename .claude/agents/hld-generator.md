...
tools: Read, Glob, Grep, Bash, Write, WebFetch, Agent, mcp__claude_ai_Figma__get_design_context, mcp__claude_ai_Figma__get_screenshot, mcp__claude_ai_Atlassian__createConfluencePage
---
...
- [ ] Every Figma URL has `claudeOutput/figma-capui-mapping/<nodeId>.recipe.json` written to disk
...
2. Fill all 15 sections using data from Phases 2-5
...
5. Verify all `{{PLACEHOLDER}}` tokens are replaced
6. Target 3000-6000 words
