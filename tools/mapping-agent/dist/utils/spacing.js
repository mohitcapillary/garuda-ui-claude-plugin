...
exports.findSpacingToken = findSpacingToken;
 ...
 */
function findSpacingToken(px, tokens) {
    var _a;
    ...
    if (tokens === null || tokens === void 0 ? void 0 : tokens.length) {
        ...
        if (spacingTokens.length > 0) {
            ...
            for (const token of spacingTokens) {
                const tokenPx = parseFloat((_a = token.figmaValuePattern) !== null && _a !== void 0 ? _a : '');
                if (isNaN(tokenPx))
                    continue;
