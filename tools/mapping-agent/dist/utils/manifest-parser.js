...
exports.needsChunking = needsChunking;
 ...
 */
function extractBoundingBox(attrs) {
    var _a, _b, _c, _d;
    return {
        x: parseFloat((_a = attrs['x']) !== null && _a !== void 0 ? _a : '0') || 0,
        y: parseFloat((_b = attrs['y']) !== null && _b !== void 0 ? _b : '0') || 0,
        width: parseFloat((_c = attrs['width']) !== null && _c !== void 0 ? _c : '0') || 0,
        height: parseFloat((_d = attrs['height']) !== null && _d !== void 0 ? _d : '0') || 0,
    };
}
/**
...
function isXmlComplete(xml) {
    ...
    const openCount = ((_a = trimmed.match(/<[^\/!?][^>]*[^\/]>/g)) !== null && _a !== void 0 ? _a : []).length
        + ((_b = trimmed.match(/<[^\/!?]>/g)) !== null && _b !== void 0 ? _b : []).length; // single-char tags e.g. <b>
    const closeCount = ((_c = trimmed.match(/<\/[^>]+>/g)) !== null && _c !== void 0 ? _c : []).length;
    const selfClose = ((_d = trimmed.match(/<[^>]+\/>/g)) !== null && _d !== void 0 ? _d : []).length;
 ...
 */
function inferLayoutMode(children) {
 ...
 */
function parseManifest(metadataXml) {
    var _a, _b;
    ...
    const roots = (0, metadata_parser_1.parseXml)(trimmed);
    const root = roots[0];
    if (!root) {
        return {
            rootNodeId: '',
    ...
    const sections = root.children
        ...
        return {
            nodeId: toDashId((_a = child.attrs['id']) !== null && _a !== void 0 ? _a : ''),
            name: (_b = child.attrs['name']) !== null && _b !== void 0 ? _b : '',
    ...
    return {
        rootNodeId: toDashId((_a = root.attrs['id']) !== null && _a !== void 0 ? _a : ''),
        rootName: (_b = root.attrs['name']) !== null && _b !== void 0 ? _b : '',
        rootBoundingBox,
        rootLayoutMode,
        sections,
        estimatedNodeCount,
 ...
 */
function needsChunking(manifest, threshold = CHUNK_THRESHOLD) {
